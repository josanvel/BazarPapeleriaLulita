...
class Ui_Eliminar(object):
    def setupUi(self, Eliminar):
        ...
        self.btnImprimir = QtGui.QPushButton(Eliminar)
    ...
    def retranslateUi(self, Eliminar):
        ...
        self.btnImprimir.setToolTip(_translate("Eliminar", "<html><head/><body><p><span style=\" color:#ffffff;\">ELIMINAR</span></p></body></html>", None))
        self.btnImprimir.setText(_translate("Eliminar", "ELIMINAR", None))
