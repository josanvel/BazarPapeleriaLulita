...
""))
        ...
        self.btnEliminar = QtGui.QPushButton(self.cwgtPrincipal)
        self.btnEliminar.setGeometry(QtCore.QRect(410, 310, 170, 50))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.btnEliminar.setStyleSheet(_fromUtf8("Color:rgb(0, 0, 0);"))
    ...
    def retranslateUi(self, VentanaPrincipal):
        ...
        self.btnEliminar.setToolTip(_translate("VentanaPrincipal", "<html><head/><body><p><span style=\" color:#ffffff;\">ELIMINAR</span></p></body></html>", None))
        self.btnEliminar.setText(_translate("VentanaPrincipal", "ELIMINAR", None))
