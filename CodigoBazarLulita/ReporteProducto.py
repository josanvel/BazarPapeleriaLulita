...
class Ui_ReporteProducto(object):
    def setupUi(self, ReporteProducto):
        ...
        self.btnGenerar = QtGui.QPushButton(ReporteProducto)
        self.btnGenerar.setGeometry(QtCore.QRect(260, 100, 200, 25))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Comic Sans MS"))
        font.setPointSize(13)
        font.setBold(True)
        ...
        self.btnGenerar.setMouseTracking(True)
    ...
    def retranslateUi(self, ReporteProducto):
        ...
        self.btnGenerar.setToolTip(_translate("ReporteProducto", "<html><head/><body><p><span style=\" color:#ffffff;\">GENERAR</span></p></body></html>", None))
        self.btnGenerar.setText(_translate("ReporteProducto", "GENERAR", None))
