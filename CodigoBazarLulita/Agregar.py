...
class Ui_Agregar(object):
    def setupUi(self, Agregar):
        ...
        Agregar.setMinimumSize(QtCore.QSize(450, 370))
        ...
        self.lblBazarPapeleriaLulita.setGeometry(QtCore.QRect(110, 0, 241, 20))
        font = QtGui.QFont()
        ...
        self.txtDescripcion = QtGui.QLineEdit(Agregar)
        self.txtDescripcion.setGeometry(QtCore.QRect(40, 120, 351, 25))
        self.txtDescripcion.setAutoFillBackground(True)
        ...
        self.spinBoxCantidad = QtGui.QSpinBox(Agregar)
        self.spinBoxCantidad.setGeometry(QtCore.QRect(200, 165, 191, 27))
    ...
    def retranslateUi(self, Agregar):
        ...
        self.txtDescripcion.setToolTip(_translate("Agregar", "<html><head/><body><p><span style=\" color:#ffffff;\">Descripcion del producto</span></p></body></html>", None))
        self.txtDescripcion.setPlaceholderText(_translate("Agregar", "Descripción del producto nuevo", None))
        ...
        self.spinBoxCantidad.setToolTip(_translate("Agregar", "<html><head/><body><p><span style=\" color:#ffffff;\">Cantidad del producto</span></p></body></html>", None))
