...
class Ui_ReporteGanancia(object):
    def setupUi(self, ReporteGanancia):
        ...
        self.btnGuadar = QtGui.QPushButton(ReporteGanancia)
        self.btnGuadar.setGeometry(QtCore.QRect(250, 110, 200, 25))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Comic Sans MS"))
        font.setPointSize(13)
        font.setBold(True)
        ...
        self.dateTimeEdit_2 = QtGui.QDateTimeEdit(ReporteGanancia)
        self.dateTimeEdit_2.setGeometry(QtCore.QRect(250, 70, 200, 27))
        self.dateTimeEdit_2.setObjectName(_fromUtf8("dateTimeEdit_2"))
        self.dateTimeEdit = QtGui.QDateTimeEdit(ReporteGanancia)
        self.dateTimeEdit.setGeometry(QtCore.QRect(40, 70, 200, 27))
    ...
    def retranslateUi(self, ReporteGanancia):
        ...
        self.btnGuadar.setToolTip(_translate("ReporteGanancia", "<html><head/><body><p><span style=\" color:#ffffff;\">GENERAR</span></p></body></html>", None))
        self.btnGuadar.setText(_translate("ReporteGanancia", "GENERAR", None))
        ...
        self.dateTimeEdit_2.setToolTip(_translate("ReporteGanancia", "Fecha Final", None))
        self.dateTimeEdit.setToolTip(_translate("ReporteGanancia", "Fecha Inicial", None))
